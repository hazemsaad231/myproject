...
<p className="text-xl w-[300px] sm:[320px]  md:w-[350px] lg:w-[400px] xl:w-[500px]  text-gray-500 py-2">يعيش اليمنــيون وضعاً ســيئا للـغاية منذ عـام 2014 , حيث توالت الصراعات المسلحة والحروب العسكــرية والنكبـــات السياسيـــة والأزمــــات الاقــــــتصــادية والمشـــــاكــل الاجــتــماعية.</p>
